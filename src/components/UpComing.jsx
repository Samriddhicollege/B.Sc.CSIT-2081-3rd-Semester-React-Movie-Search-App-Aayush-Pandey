      ...
      <div className="trending mt-5 px-4">
        ...
        <div>
          <Swiper
            ...
            spaceBetween={10} // Equal spacing between cards
            autoplay={{
              delay: 2500,
            ...
            breakpoints={{
              ...
              1440: { slidesPerView: 6, spaceBetween: 10 }, // Large desktops
              1300:{slidesPerView:5, spaceBetween:10},
              1200: { slidesPerView: 4, spaceBetween: 10 }, // Medium desktops
              900: { slidesPerView: 3, spaceBetween: 10 }, // Tablets
